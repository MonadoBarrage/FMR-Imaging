...
def parameters(argv=None):
    ...
    parser.add_argument(
        ...
        metavar="DATASET",
        help="dataset type (default: 7scene)",
    )
    parser.add_argument(
        "-o",
        "--outfile",
    ...
    parser.add_argument(
        "--pretrained",
        default="./result/fmr_model_7scene.pth",
        type=str,
        metavar="PATH",
    ...
    parser.add_argument(
        "--mode", default="train", help="program mode. This code is for training"
    )
    parser.add_argument(
        "--uniformsampling",
        default=False,
        type=bool,
        help="uniform sampling points from the mesh",
    )
...
def main(args):
    ...
    # training
    fmr = model.FMRTrain(
        dim_k=args.dim_k, num_points=args.num_points, train_type=args.train_type
    )
...
def run(args, trainset, testset, action):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print(
            "epoch, %04d, floss_train=%f, floss_val=%f"
